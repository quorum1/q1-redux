...
// node_modules/@awesome.me/webawesome/dist/chunks/chunk.K43TEC7B.js
...
var WebAwesomeElement = class extends LitElement {
  constructor() {
    ...
    this.customStates = {
      ...
      set: (customState, active) => {
        var _a3;
        if (!Boolean((_a3 = this.internals) == null ? void 0 : _a3.states)) return;
        try {
          if (active) {
      ...
      has: (customState) => {
        var _a3;
        if (!Boolean((_a3 = this.internals) == null ? void 0 : _a3.states)) return false;
        try {
  ...
  firstUpdated(changedProperties) {
    ...
    if (this.didSSR) {
      (_a3 = this.shadowRoot) == null ? void 0 : _a3.querySelectorAll("slot").forEach((slotElement) => {
...
@awesome.me/webawesome/dist/chunks/chunk.K43TEC7B.js:
  (*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license *)
*/
//# sourceMappingURL=chunk-I23QJHL2.js.map
